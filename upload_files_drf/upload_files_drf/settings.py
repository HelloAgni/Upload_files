"""
Django settings for upload_files_drf project.
...
SECRET_KEY = os.getenv('SECRET_KEY', default='django-insecure-cjhpl2!2s$w9go7+#!kf0u_)+++m3ayv%yxrl%^7fj1mkd+zpm')
...
ROOT_URLCONF = 'upload_files_drf.urls'
...
WSGI_APPLICATION = 'upload_files_drf.wsgi.application'
